sap.ui.define([
    ...
    return Controller.extend("code.t3.ui5.review2.controller.Main", {
        onInit() {
            // const는 상수를 선언할 때 사용합니다. 한 번 할당된 값은 변경할 수 없습니다.
            // let는 변수를 선언할 때 사용합니다. 동일한 이름으로 새로 선언할 수 없다. 요즘은 이렇게 많이 쓰라고 함.
            // var는 변수를 선언할 때 사용합니다. 동일한 이름으로 새로 선언할 수 있다. 옛날에 많이 씀.
        ...
        onReset(){
            ...
            // 여기서는 name, age, city 속성을 초기값으로 설정하여 모델의 데이터를 초기화 합니다.
            oModel.setData({
        ...
        onSave(){
            ...
            // Manifest.json에 설정한 모델을 가져온다. (sap라는 이름으로 설정했음)
            ...
            // result라는 이름으로 oResultModel을 뷰에 설정합니다.
            ...
            // 오른쪽 피연산자의 값을 할당합니다.
            // this.oDialog가 빈 값일 때만 오른쪽의 this.loadFragment(...)의 결과를 가져온다. 
            that.pDialog ??=that.loadFragment({
                name: "code.t3.ui5.review2.view.Result"
            });
